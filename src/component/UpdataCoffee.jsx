...
const UpdataCoffee = () => {
    ...
    return (
        <div style={style} className='min-w-11/12 mx-auto'>
            ...
            <div className=' lg:w-1/2 text-center mx-auto mt-20 mb-20 sm:p-10 p-10 space-y-4 bg-[#F4F3F0]'>
                <h2 className=' text-4xl font-bold text-[#331A15] text-shadow-lg  '>Update Existing Coffee Details</h2>
                ...
                <form>
                    <div className="grid grid-cols-2 gap-x-5 gap-y-6">
                        ...
                        <fieldset className="col-span-2">
                            <button className="btn w-full bg-[#D2B48C] border-[#331A15]">Update Coffee Details</button>
                        </fieldset>
                    </div>
                </form>
